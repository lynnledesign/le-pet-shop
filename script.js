...
let scenes = [
  ...
  { type: "dialogue", 
    text: "Le Pet Shop ", 
    image: "images/house.gif", maxWidth: "500px", 
    buttonText: "Enter",
   ...
   { type: "dialogue", 
    isCreatorNote: true,
    text: "<strong>Creator Note:</strong> Open a different tab and put some lo-fi music on for extra cozy vibes :) I recommend a nostalgic gametrack. My personal pick would be the Pokemon Ruby Soundtrack.",  
    image: "images/lynn.png", maxWidth: "100px",
    buttonText: "Close",
    sound: "sounds/blip.mp3"
   },
  
  { type: "dialogue", 
    text: "Hi, I'm Magnolia, the shopkeeper! You must be here for a cat?", 
    image: "images/Sprite.gif", maxWidth: "175px",
    fadeIn: true,
    buttonText: "Yes, I am!",
    sound: "sounds/blip.mp3"
   },
  ...
  { type: "dialogue", 
    text: "That is so exciting! We’ll have you answer a few questions so we can learn more about your personality.", 
    image: "images/Sprite-2.gif", maxWidth: "175px",
    fadeIn: true, 
    sound: "sounds/blip.mp3"
    },

    { type: "dialogue", 
    text: "This will help us decide which cat is the best fit for you. No pressure at all, just be yourself and have fun!", 
    image: "images/Sprite.gif", maxWidth: "175px",
    fadeIn: true, 
    sound: "sounds/blip.mp3"
    },
  ...
  { type: "dialogue", 
    text: "Just going to ask some casual questions to get things started!", 
